...
def load_model():
    model = keras.models.load_model('models/cnn0a-173-model0200+50-no2-adam.h5')
    model.summary()
    return(model)
...
model.save('models/cnn0a-160-model0250+50-adam.h5')
cv2.imwrite('validate/'+'cnn0a-160-0250+50-adam.png',
