...
# x29 = BatchNormalization(axis=-1)(x28)train_images = train_images.astype('float32') / 255
x30 = Activation('relu')(x28)
...
# model = cnn1_model
plot_model(cnn1_model, show_shapes=True, to_file='models/cnn1_model.png')


def load_model():
    model = keras.models.load_model(
        'models/cnn0a-173-model0200+50-no2-adam.h5')
    model.summary()
    return(model)
...
model.save('models/cnn0a-200-model0300+50-adam.h5')
cv2.imwrite('validate/'+'cnn0a-200-300+50-adam.png',
