...
def load_model():
    model = keras.models.load_model('models/cnn2a-bmodel-shd-1npy-465-40.h5')
    return(model)
...
save1nnwrap()
save1wrap()
model.save('models/cnn2a-bmodel-shd-1npy-465-40.h5')
cv2.imwrite('validate/'+'cnn2a-shd-1npy-465-100-0.png',
            (1.0*combotot).astype(np.uint8))